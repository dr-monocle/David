timeSL = ['Right now it is ', 'It is ', 'Now, it is ']
timePL = ['Right now it\'s ', 'It\'s ', 'Now, it\'s ']

errorL = ['Please repeat', 'Can you repeat, please?', 'Sorry, I didn\'t understand', 'Sorry, can you repeat, please?']
